...
class PPArandom:
    ...
    '''
    def __init__(self, graph, priority_nodes, depth, path_to_folder, graph_name):
    ...
    def callback_next_task(self, req):
        ...
        dest = rn.sample(self.priority_nodes,1)[0]
    ...
    def callback_ready(self, req):
        ...
        Verify algorithm
        '''
        if req.algo == 'ppa_random' and self.ready:
...
if __name__ == '__main__':
    rospy.init_node('ppa_random', anonymous = True)
    ...
    s = PPArandom(g, priority_nodes, depth, path_to_folder, graph_name)
