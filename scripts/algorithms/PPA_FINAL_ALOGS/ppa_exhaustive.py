...
class ppa_exhaustive:
    ...
    def callback_ready(self, req):
        ...
        Verify algorithm
        '''
        if req.algo == 'ppa_exhaustive' and self.ready:
...
if __name__ == '__main__':
    rospy.init_node('ppa_exhaustive', anonymous = True)
    ...
    s = ppa_exhaustive(g, priority_nodes, depth, path_to_folder, graph_name)
