...
class PPAgreedy:
    ...
    def callback_ready(self, req):
        algo_name = req.algo
        if algo_name == 'ppa_greedy' and self.ready:
            return AlgoReadyResponse(True)
        else:
            return AlgoReadyResponse(False)

if __name__ == '__main__':
    rospy.init_node('ppa_greedy', anonymous = True)
    ...
    s = PPAgreedy(g, priority_nodes, depth, path_to_folder, graph_name)
